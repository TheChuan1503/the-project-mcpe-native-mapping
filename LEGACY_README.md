...
- [Table](#table)
  ...
  - [1.21.113.1\_arm64-v8a](#1211131_arm64-v8a)
    - [Abilities](#abilities-6)
    - [Actor](#actor-6)
    - [ActorEntityAccess](#actorentityaccess-1)
    - [AppPlatform](#appplatform-1)
    - [BaseActorRenderer](#baseactorrenderer-1)
    - [BaseOptions](#baseoptions-1)
    - [Block](#block-1)
    - [BlockMovementSlowdownMultiplierSystemImpl](#blockmovementslowdownmultipliersystemimpl-1)
    - [BlockSource](#blocksource-1)
    - [CameraAvoidanceSystem](#cameraavoidancesystem-1)
    - [CameraBlendSystem](#camerablendsystem-1)
    - [CameraBobSystem](#camerabobsystem-1)
    - [CameraPortalDistortionSystem](#cameraportaldistortionsystem-1)
    - [CameraVehicleRotationLookSystem](#cameravehiclerotationlooksystem-1)
    - [ClientInputCallbacks](#clientinputcallbacks-1)
    - [ClientInstance](#clientinstance-6)
    - [Entitlement](#entitlement-1)
    - [FullScreenEffectRenderer](#fullscreeneffectrenderer-1)
    - [GameMode](#gamemode-6)
    - [GameplayUserManager](#gameplayusermanager-1)
    - [GuiData](#guidata-5)
    - [HudPlayerRenderer](#hudplayerrenderer-1)
    - [HudVignetteRenderer](#hudvignetterenderer-1)
    - [ItemUseSlowdownSystemImpl](#itemuseslowdownsystemimpl-1)
    - [LayeredAbilities](#layeredabilities-1)
    - [Level](#level-5)
    - [LevelRenderer](#levelrenderer-1)
    - [LevelRendererCamera](#levelrenderercamera-1)
    - [LevelRendererPlayer](#levelrendererplayer-5)
    - [LocalPlayer](#localplayer-5)
    - [MinecraftGame](#minecraftgame-3)
    - [Mob](#mob-2)
    - [MobJump](#mobjump-1)
    - [MobMovementGravity](#mobmovementgravity-1)
    - [MoveCollisionSystem](#movecollisionsystem-1)
    - [NetherNet::SimpleNetworkInterfaceImpl](#nethernetsimplenetworkinterfaceimpl-1)
    - [Player](#player-6)
    - [TileMessage](#tilemessage-1)
...
## 1.21.113.1_arm64-v8a
_此表依据 1.21.111.1 特征码得到，未经验证_
